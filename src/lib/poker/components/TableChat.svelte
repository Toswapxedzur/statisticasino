<script>
  // Compact table chat: a scrollable list of {from, text, ts} messages
  // plus an input. Enter or the Send button calls onSend(text) and clears
  // the field. The list is height-capped and auto-scrolls to the newest
