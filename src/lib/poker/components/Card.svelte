<script>
  ...
  // Playing Cards 3.0" (LGPL 3.0) with the corner indices enlarged for
  // legibility (the "Replay treatment"), served whole from /cards/ at every
  // size. Back + empty slot are original Riverside art at the 63×88 ratio.
  //
...
<style>
  ...
  .rvcard.face { background: #fff; filter: drop-shadow(0 1px 2px rgba(0, 0, 0, 0.4)); }
